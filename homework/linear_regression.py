...
class LinearRegression:
    ...
    def __init__(self, num_epochs=100, learning_rate=0.01):
        ...
        self.num_epochs = num_epochs # Numero de sitios de optimizacion
        self.learning_rate = learning_rate

    def fit(self, X, y):
        """Fit the model using X, y."""

        self.coefs_ = np.random.rand(X.shape[1])  #Vector de coeficientes
        self.intercept_ = np.random.rand() #Intercepto , parametros estimados siempre terminan en _ para diferenciarlos de los originales
